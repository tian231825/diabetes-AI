...
class DiabetesPrescriptionSystemRefactored:
    ...
    def _initialize_builtin_conditions(self):
        ...
        self.conditions["normal_weight"] = Condition(
            ...
            lambda p: p.bmi < 28 and p.bmi >= 18.5
        )
        ...
        self.conditions["AGi_blood_glucose"] = Condition(
            "AGi_blood_glucose",
            "轻度减轻体重",
            lambda p: p.delta_blood_glucose_after_meal > 6
        )
        ...
        self.conditions["Fracture_FORBID"] = Condition(
            "Fracture_FORBID",
            "有严重骨质疏松或骨折病史的人",
            lambda p: "骨折史" in p.history or "骨质疏松" in p.risk_factors
        )
        ...
        self.conditions["Ketosis_FORBID"] = Condition(
            ...
            lambda p: "酮症" in p.complications or "酮症酸中毒" in p.complications or "高渗透性高" in p.complications
                      or "HHS" in p.complications
        )
    ...
    def _initialize_rules(self):
        ...
        self.rules.append(DrugRule(
            ...
            description="合并ASCVD患者推荐心肾保护药物SGLT2I,GLP-1RA 指南2025 [8], 联合MET 潜在获益，联合TZD （吡格列酮）",
            required_conditions={"ascvd_present"},
            recommend_drug_categories={DrugCategory.GLP1RA, },
            consider_drug_categories={DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, DrugCategory.MET, DrugCategory.TZD1},
            type=1
        ))

        self.rules.append(DrugRule(
            rule_id="ascvd_protection_2",
            description="合并ASCVD或高风险患者推荐心肾保护药物SGLT2I,GLP-1RA  指南2025 [8] (指标判定), 联合MET 潜在获益，联合TZD （吡格列酮）",
            recommend_drug_categories={DrugCategory.GLP1RA, },
            consider_drug_categories={DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, DrugCategory.MET, DrugCategory.TZD1},
        ...
        self.rules.append(DrugRule(
            ...
            description="合并心衰患者推荐SGLT2I, 禁用TZD, 慎用沙格列汀(指南),阿格列汀（吴正昊）",
        ...
        self.rules.append(DrugRule(
            ...
            description="合并CKD患者推荐SGLT2I, GLP-1RA 潜在获益 指南2025 [8]",
            recommend_drug_categories={DrugCategory.SGLT2I1, DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, },
        ...
        self.rules.append(DrugRule(
            ...
            description="9- 没有SGLTI2或GLP-1RA心神保护强适应症的情况下 通常选择以met为基础的联合治疗+西格列汀",
            recommend_drug_categories={DrugCategory.MET, },
            consider_drug_categories={DrugCategory.DPP4I1},
            required_conditions={},
        ...
        self.rules.append(DrugRule(
            ...
            description="超重/肥胖患者 一线药物选择推荐MET,AGI, SGLT2I GLP-1RA; 禁用 SU",
            recommend_drug_categories={DrugCategory.AGI, DrugCategory.GLP1RA},
            consider_drug_categories={DrugCategory.MET, DrugCategory.SGLT2I1, DrugCategory.SGLT2I2, DrugCategory.SGLT2I3,
        ...
        self.rules.append(DrugRule(
            rule_id="lack_weight",
            description="BMI低, 推荐DPP-4I, 禁用SGLT2I,GLP-1RA",
        ...
        self.rules.append(DrugRule(
            ...
            description="合并MASLD脂肪肝， 推荐使用MET 吡格列酮 GLP-1RA",
            required_conditions={"MASLD_present"},
            recommend_drug_categories={DrugCategory.GLP1RA},
            consider_drug_categories={DrugCategory.MET, DrugCategory.TZD1},
        ...
        self.rules.append(DrugRule(
            ...
            description="合并Hyperlipidemia高脂血症 推荐使用的MET 与TZD",
        ...
        self.rules.append(DrugRule(
            rule_id="hypertension_present",
            description="胃轻瘫 /胃炎禁用GLP-1RA和alpha糖苷酶抑制剂",
        ...
        self.rules.append(DrugRule(
            ...
            description="代谢综合征 推荐使用双胍类，SGLT2i, GLP-1RA, TZD，PPAR，禁用磺脲类",
            recommend_drug_categories={DrugCategory.MET},
        ...
        self.rules.append(DrugRule(
            ...
            description="卒中病史者选用GLP-1RA或吡格列酮",
        ...
        self.rules.append(DrugRule(
            ...
            description="酮症、酮症酸中毒、高渗透性高HHS 禁用SGLT2I DPP4I SU TZD PPAR GKA AGI MET药物",
            forbid_drug_categories={DrugCategory.SGLT2I1, DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, DrugCategory.SGLT2I4,
                                    DrugCategory.SGLT2I5, DrugCategory.SGLT2I6, DrugCategory.GLP1RA, DrugCategory.DPP4I1,
                                    DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I4, DrugCategory.DPP4I5, DrugCategory.DPP4I6,
                                    DrugCategory.DPP4I7,
        ...
        self.rules.append(DrugRule(
            ...
            description="肾衰竭、肾透析 禁用SGLT2I DPP4I SU TZD PPAR GKA AGI MET药物",
            forbid_drug_categories={DrugCategory.SGLT2I1, DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, DrugCategory.SGLT2I4,
                                    DrugCategory.SGLT2I5, DrugCategory.SGLT2I6, DrugCategory.GLP1RA, DrugCategory.DPP4I1,
                                    DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I4, DrugCategory.DPP4I5, DrugCategory.DPP4I6,
                                    DrugCategory.DPP4I7,
        ...
        self.rules.append(DrugRule(
            ...
            description="严重肝功能不全,禁用SGLT2I,GLP-1RA, DPP4I,SU, TZD, PPAR, GKA, MET, AGI",
            forbid_drug_categories={DrugCategory.SGLT2I1, DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, DrugCategory.SGLT2I4,
                                    DrugCategory.SGLT2I5, DrugCategory.SGLT2I6, DrugCategory.GLP1RA, DrugCategory.DPP4I1,
                                    DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I4, DrugCategory.DPP4I5, DrugCategory.DPP4I6,
                                    DrugCategory.DPP4I7,
        ...
        self.rules.append(DrugRule(
            ...
            description="胰岛功能差的患者推荐Met;alpha糖苷酶抑制剂 SGLT2i GKA 可用;禁用 GLP DPP-4I SU TZD PPAR;\n胰岛功能差，胰岛素分泌差，促泌剂也没效果",
            recommend_drug_categories={DrugCategory.MET},
            ...
            excluded_conditions={"beta_cell_function"},
            type=2
        ))

        self.rules.append(DrugRule(
            rule_id="insulin_resistance_forbid",
            description="胰岛素强抵抗禁止GLP-1RA DPP4I SU GKA GLN 药物;\n胰岛素抵抗，胰岛素分泌的好，不需要促泌剂",
            forbid_drug_categories={DrugCategory.GLP1RA, DrugCategory.DPP4I1, DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I4,
                                    DrugCategory.DPP4I5, DrugCategory.DPP4I6, DrugCategory.DPP4I7, DrugCategory.SU1, DrugCategory.SU2,
                                    DrugCategory.SU3, DrugCategory.SU4, DrugCategory.SU5, DrugCategory.GLN, DrugCategory.GKA},
        ...
        self.rules.append(DrugRule(
            ...
            description="有严重骨质疏松或骨折病史的人禁用PPAR",
            forbid_drug_categories={DrugCategory.PAN_PPARA, DrugCategory.TZD1, DrugCategory.TZD2},
        ...
        self.rules.append(DrugRule(
            rule_id="CKD3A",
            description="CKD3A期 格列喹酮 格列奈类 TZD GLN alpha糖苷酶抑制剂 DPP-4I 可用/推荐; 二甲双胍 格列美脲 格列吡嗪 格列齐特 达格列净 卡格列净 恩格列净 慎用; 格列苯脲 禁用; ",
        ...
        self.rules.append(DrugRule(
            rule_id="CKD3B",
            description="CKD3B期 格列喹酮 格列奈类 TZD GLN  alpha糖苷酶抑制剂 利格列汀 推荐/可用; 格列吡嗪 格列齐特 西格列汀 维格列汀 沙格列汀 阿格列汀 慎用; 二甲双胍 格列苯脲 格列美脲 SGLT2I类 禁用",
            recommend_drug_categories={DrugCategory.SU4, DrugCategory.GLN, DrugCategory.TZD2, DrugCategory.TZD1, DrugCategory.AGI,
                                       DrugCategory.DPP4I4},
        ...
        self.rules.append(DrugRule(
            rule_id="CKD4",
            description="CKD4期 格列喹酮 格列奈类 TZD GLN 利格列汀 推荐/可用; 西格列汀 维格列汀 沙格列汀 阿格列汀 慎用; 二甲双胍 SU（除了格列喹酮SU4） SGLT2I类 禁用",
        ...
        self.rules.append(DrugRule(
            ...
            description="CKD5期 格列喹酮 格列奈类 TZD GLN 利格列汀 推荐/可用; 西格列汀 维格列汀 沙格列汀 阿格列汀 慎用; 二甲双胍 SU（除了格列喹酮SU4） SGLT2I类 禁用",
            recommend_drug_categories={DrugCategory.SU4, DrugCategory.GLN, DrugCategory.TZD2, DrugCategory.TZD1, DrugCategory.DPP4I4},
            caution_drug_categories={DrugCategory.DPP4I1, DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I5,
                                     DrugCategory.DPP4I6, DrugCategory.DPP4I7},
            forbid_drug_categories={DrugCategory.MET, DrugCategory.SU1, DrugCategory.SU2, DrugCategory.SU3, DrugCategory.SU5, DrugCategory.AGI,
        ...
        self.rules.append(DrugRule(
            ...
            description="低血糖风险高 推荐DPP-4i,Met;磺脲类, 格列奈类",
            recommend_drug_categories={DrugCategory.DPP4I1, DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I4, DrugCategory.DPP4I5,
                                       DrugCategory.DPP4I6, DrugCategory.DPP4I7},
            consider_drug_categories={DrugCategory.MET},
        ...
        self.rules.append(DrugRule(
            rule_id="DPP4I_MET",
            description="DPP4I 和二甲双胍双联适用于 老年、低血糖风险高，胃肠道不良反应",
        ...
        self.rules.append(DrugRule(
            rule_id="SU_CAUTION",
            description="18 SU 增加低血糖风险 老年 肝肾功能不全者慎用",
            caution_drug_categories={DrugCategory.SU1, DrugCategory.SU2, DrugCategory.SU3, DrugCategory.SU4, DrugCategory.SU5},
        ...
        self.rules.append(DrugRule(
            ...
            description="10- 磺脲类或格列奈类疗效确切，但增加低血糖风险和体重，故与met联合治疗使用于年轻人 初诊HB1AC较高 胰岛素β细胞功能较好 不伴超重或肥胖的患者",
        ...
        self.rules.append(DrugRule(
            rule_id="AGI_MET",
            description="可轻度减轻体重，适用于餐后血糖控制差的T2DM患者",
        ...
        self.rules.append(DrugRule(
            ...
            description="20 联合治疗方案中包含SGLT2I 泌尿生殖系感染风险增加，应注意个人外阴部卫生适当增加饮水量",
            forbid_drug_categories={DrugCategory.SGLT2I1, DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, DrugCategory.SGLT2I4, DrugCategory.SGLT2I5},
        ...
        self.rules.append(DrugRule(
            ...
            description="19 TZD 与沙格列汀 与HF风险增加有关，HF病史和HF诱发因素的患者慎用",
        ...
        self.rules.append(DrugRule(
            rule_id="TZD_CAUTION",
            description="TZD是慎用于心衰/骨质疏松/肝酶升高者 (前两个在其他规则中已被禁用)",
        ...
        self.rules.append(DrugRule(
            ...
            description="19 TZD 使用与骨折风险增加相关 有严重骨质疏松或骨折病史的人禁用",
            forbid_drug_categories={DrugCategory.TZD1, DrugCategory.TZD2},
            required_conditions={"Fracture_FORBID"},
            type=3
        ))
        self.rules.append(DrugRule(
            rule_id="TZD_PPAR",
            description="TZD或PPAR疗效确切，低血糖风险小，但可增加体重，其与met联合治疗使用于伴有明显胰岛素抵抗的T2DM患者",
        ...
        self.rules.append(DrugRule(
            ...
            description="24 GLP-1RA仅用于甲状腺髓样癌，多发性内分泌腺瘤病2型既往史或家族史的患者，有胰腺炎病史的患者慎用此药",
        ...
        self.rules.append(DrugRule(
            rule_id="GKA",
            description="16 GKA改善血糖稳态失调 与met兼顾空腹和餐后血糖；适合病程较短 胰岛细胞功能较好的患者",
        ...
        self.rules.append(DrugRule(
            ...
            description="70岁以下血糖高的，以二甲双胍为基础的单药/联合治疗 ",
        ...
        self.rules.append(DrugRule(
            ...
            description="血糖特别高的，70岁以上患者，以二甲双胍为基础的单药/联合治疗,指南2025 [6]",
            recommend_drug_categories={DrugCategory.MET},
        ...
        self.rules.append(DrugRule(
            ...
            description="25 老年患者建议优选MET,DDP4I,SGLT2I,GLP-1RA 或以此为基础的联合治疗方案，减少低血糖风险; 26 权衡SGLT2I 和GLP-1RA的治疗获益与风险",
            recommend_drug_categories={DrugCategory.MET, DrugCategory.DPP4I1, DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I4,
                                       DrugCategory.DPP4I5,
                                       DrugCategory.DPP4I6, DrugCategory.DPP4I7},
        ...
        self.rules.append(DrugRule(
            ...
            description="未成年人 仅批准使用二甲双胍应用于10-18随的儿童和青少年",
            recommend_drug_categories={DrugCategory.MET, },
            forbid_drug_categories={DrugCategory.SGLT2I1, DrugCategory.SGLT2I2, DrugCategory.SGLT2I3, DrugCategory.SGLT2I4,
                                    DrugCategory.SGLT2I5, DrugCategory.SGLT2I6, DrugCategory.GLP1RA, DrugCategory.DPP4I1,
                                    DrugCategory.DPP4I2, DrugCategory.DPP4I3, DrugCategory.DPP4I4, DrugCategory.DPP4I5, DrugCategory.DPP4I6,
