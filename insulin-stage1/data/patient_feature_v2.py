...
class PatientFeatureExtractor:
    ...
    def _load_extra_features() -> Dict[str, Dict[str, Any]]:
        extra_path_override = os.environ.get("FEATURE_EXTRA_PATH")
        extra_path = Path(extra_path_override) if extra_path_override else Path(__file__).resolve().parent.parent / "feature_extra.json"
