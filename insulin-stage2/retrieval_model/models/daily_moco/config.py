...
def build_config():
    ...
    parser.add_argument('--d_insulin', type=int, default=5)
    parser.add_argument('--d_drug', type=int, default=17)
    parser.add_argument('--regimen_flag_dim', type=int, default=2)
    parser.add_argument('--use_regimen', type=int, default=0)
